...
capacity is 1-D in time, not 3-D in cells — so it is the one authority every planner can consult
at plan time. The column radius is a **per-hub constant** (asserted on record).
