...
def _warn_if_terminal_dropped(req: FlightRequest, intent: OperationalIntent) -> None:
    ...
    Only A*-based geometry tags a hub flight's terminal column; the refiners (shortcut/MILP/NLP) and
    the non-A* planners (straight/RRT*) rebuild corridors and drop the tag, which silently disables the
